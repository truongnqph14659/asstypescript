            ...
            <form name='form_input'>
                <div class="w-[800px] bg-white flex">
                    <div class="w-[500px] flex-none p-[45px]">
                        ...
                        <button id="btn-submit" type="submit" class="block mt-2 py-4 text-center bg-red-600 text-white w-full">Đăng nhập</button>
                    </div>
            ...
            (<any>$("form[name='form_input']")).validate({
                ...
                submitHandler: async function (form:any,event:any) {
                    ...
                    try {
                        ...
                        if(resault){
                            localStorage.setItem('user', JSON.stringify(resault.data.user))
