...
import { createProduct,getCate,getExpand } from "../../../api/product"
...
const AddProductPage = {
                ...
                <form name='form_input'>
                    <div class="grid grid-cols-3 gap-8">
                        <div class="">
                            <div class="flex flex-col justify-center items-center border rounded-md h-[250px]">
                                <div class="space-y-1 text-center">
                                    <img src="" id="preview" class="w-[100px] h-[100px]" />
                        ...
                        <div class="col-span-2">
                            ...
                            <input id="name" name="Name_product" type="text" placeholder="Tên sản phẩm" class="w-full border rounded-sm h-10">
                            </div>
                        ...
                        <div class = "mt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="feature" name="feature" rows="3" class="feature shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md h-48 " placeholder="you@example.com"></textarea>
                            </div>
                        </div>
                        <div class = "mt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="desc" name="desc" rows="3" class="feature shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md h-48 " placeholder="you@example.com"></textarea>
                            </div>
                        </div>
    ...
    afterRender: async () => {
        ...
        $(function () {
            (<any>$("form[name='form_input']")).validate({
                ...
                submitHandler: async function (form:any,event:any) {
                    ...
                    const notice = await createProduct(data)
                    if(notice){
                      swal({
        ...
        //     const originalPrice = document.querySelector('#originalPrice')as HTMLInputElement
        //     const product = new Product(name.value, +originalPrice.value) 
        //     try {
